...
**Nachweis (08-03-2026):**
- Packaging-Skript erstellt: `SyncForge.Configurator/scripts/package-configurator-windows.ps1`.
- Erzeugt Release-ZIP (framework-dependent) inkl. Plugins.
- Optional self-contained Packaging ueber `-SelfContained` vorhanden.
- End-to-end Lauf erfolgreich (lokal erzeugtes Paket):
	- `SyncForge.Configurator/artifacts/packages/windows/SyncForge.Configurator-win-framework-dependent.zip`
...
**Nachweis (08-03-2026):**
- Packaging-Skript erstellt: `SyncForge.Configurator/scripts/package-configurator-linux.sh`.
- Self-contained Binary Packaging fuer Linux ueber `--self-contained true` umgesetzt.
- Ausgabe als `tar.gz` Paket fuer Terminal-Start-Szenario.
- Skript-Syntax und CLI-Help erfolgreich validiert (`bash -n`, `--help`).
...
**Nachweis (08-03-2026):**
- Quickstart erstellt: `SyncForge.Configurator/docs/quickstart-10-min.md`.
- Screenshot-Ablage inkl. Checkliste erstellt: `SyncForge.Configurator/docs/screenshots/README.md`.
- Beispieljob-Nutzung im Guide dokumentiert (`SyncForge/examples/jobs/job-csv-run-upsert.json`).
- README um Packaging- und Quickstart-Links erweitert (`SyncForge.Configurator/README.md`).
